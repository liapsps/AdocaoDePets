// Array de pets
const pets = [
    { id: 1, name: 'Buddy', species: 'Cachorro', size: 'M', description: 'Um amigão para toda a vida!', image: '../assets/pet1.jpg' },
    { id: 2, name: 'Mittens', species: 'Gato', size: 'M', description: 'Adora um carinho!', image: '../assets/pet2.jpg' },
    { id: 3, name: 'Charlie', species: 'Cachorro', size: 'G', description: 'Energia para brincar!', image: '../assets/pet3.jpg' },
    { id: 4, name: 'Max', species: 'Cachorro', size: 'P', description: 'Muito amoroso, adora caminhadas!', image: '../assets/pet4.webp' },
    { id: 5, name: 'Luna', species: 'Gato', size: 'P', description: 'Brincalhona, adora explorar!', image: '../assets/pet5.jpg' },
    { id: 6, name: 'Simba', species: 'Gato', size: 'M', description: 'Amigável demais, ideal para família!', image: '../assets/pet6.webp' }
  ];
  ...
  function populateFilters() {
    ...
    species.forEach(species => speciesSelect.innerHTML += `<option value="${species}">${species}</option>`);
