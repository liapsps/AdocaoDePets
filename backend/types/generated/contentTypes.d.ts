...
export interface ApiPetPet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    idade: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    raca: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiSolicitacaoDeAdocaoSolicitacaoDeAdocao
  ...
  info: {
    displayName: 'Solicita\u00E7\u00E3oDeAdo\u00E7\u00E3o';
  ...
  attributes: {
    adotante: Schema.Attribute.Relation<
      'manyToOne',
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    justificativa: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::solicitacao-de-adocao.solicitacao-de-adocao'
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    solicitacao_de_adocaos: Schema.Attribute.Relation<
      'oneToMany',
      'api::solicitacao-de-adocao.solicitacao-de-adocao'
    >;
